...
namespace GraphQLTest
{
    public class Startup
    {
        ...
        {
            services
               .AddScoped<IMasterDb, MasterDb>()
               .AddScoped<IUserRepo, UserRepo>()
               .AddScoped<GraphQLDataAdapter>()
               .AddScoped<IDataAdapterFactory, DataAdapterFactory>()
               .AddScoped<IDataAdapterRepo, DataAdapterRepo>()
               .AddScoped<IRootMutation, RootMutation>()
               .AddScoped<IRootQuery, RootQuery>()
               .AddScoped<IMasterSchema, MasterSchema>();
